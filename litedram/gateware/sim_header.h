...
struct pad_s user_port_native[] = {
    { (char*)"cmd_valid", 1, NULL },
    { (char*)"cmd_ready", 1, NULL },
    { (char*)"cmd_we", 1, NULL },
    { (char*)"cmd_addr", 24, NULL },
    { (char*)"wdata_valid", 1, NULL },
    { (char*)"wdata_ready", 1, NULL },
    { (char*)"wdata_we", 16, NULL },
    { (char*)"wdata_data", 128, NULL },
    { (char*)"rdata_valid", 1, NULL },
    { (char*)"rdata_ready", 1, NULL },
    { (char*)"rdata_data", 128, NULL },
    { NULL, 0, NULL }
};
