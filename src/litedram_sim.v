...
assign soc_user_port_cmd_valid = (user_port_native_cmd_valid & soc_user_enable);
assign user_port_native_cmd_ready = (soc_user_port_cmd_ready & soc_user_enable);
assign soc_user_port_cmd_payload_we = user_port_native_cmd_we;
assign soc_user_port_cmd_payload_addr = user_port_native_cmd_addr;
assign soc_user_port_wdata_valid = (user_port_native_wdata_valid & soc_user_enable);
assign user_port_native_wdata_ready = (soc_user_port_wdata_ready & soc_user_enable);
assign soc_user_port_wdata_payload_we = user_port_native_wdata_we;
assign soc_user_port_wdata_payload_data = user_port_native_wdata_data;
assign user_port_native_rdata_valid = (soc_user_port_rdata_valid & soc_user_enable);
assign soc_user_port_rdata_ready = (user_port_native_rdata_ready & soc_user_enable);
assign user_port_native_rdata_data = soc_user_port_rdata_payload_data;
...
always @(*) begin
    ...
    case (soc_litedramcore_steerer_sel0)
        1'd0: begin
            array_muxed0 <= soc_litedramcore_nop_ba;
        end
        1'd1: begin
            array_muxed0 <= soc_litedramcore_choose_cmd_cmd_payload_ba;
        end
        2'd2: begin
            array_muxed0 <= soc_litedramcore_choose_req_cmd_payload_ba;
        end
        default: begin
            array_muxed0 <= soc_litedramcore_cmd_payload_ba;
        end
    endcase
end
always @(*) begin
...
always @(*) begin
    ...
    case (soc_litedramcore_steerer_sel1)
        1'd0: begin
            array_muxed7 <= soc_litedramcore_nop_ba;
        end
        1'd1: begin
            array_muxed7 <= soc_litedramcore_choose_cmd_cmd_payload_ba;
        end
        2'd2: begin
            array_muxed7 <= soc_litedramcore_choose_req_cmd_payload_ba;
        end
        default: begin
            array_muxed7 <= soc_litedramcore_cmd_payload_ba;
        end
    endcase
end
always @(*) begin
...
always @(*) begin
    ...
    case (soc_litedramcore_steerer_sel2)
        1'd0: begin
            array_muxed14 <= soc_litedramcore_nop_ba;
        end
        1'd1: begin
            array_muxed14 <= soc_litedramcore_choose_cmd_cmd_payload_ba;
        end
        2'd2: begin
            array_muxed14 <= soc_litedramcore_choose_req_cmd_payload_ba;
        end
        default: begin
            array_muxed14 <= soc_litedramcore_cmd_payload_ba;
        end
    endcase
end
always @(*) begin
...
always @(*) begin
    ...
    case (soc_litedramcore_steerer_sel3)
        1'd0: begin
            array_muxed21 <= soc_litedramcore_nop_ba;
        end
        1'd1: begin
            array_muxed21 <= soc_litedramcore_choose_cmd_cmd_payload_ba;
        end
        2'd2: begin
            array_muxed21 <= soc_litedramcore_choose_req_cmd_payload_ba;
        end
        default: begin
            array_muxed21 <= soc_litedramcore_cmd_payload_ba;
        end
    endcase
end
always @(*) begin
...
// -----------------------------------------------------------------------------
//  Auto-Generated by LiteX on 2025-09-30 11:35:50.
//------------------------------------------------------------------------------
