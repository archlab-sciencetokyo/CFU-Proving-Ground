...
__attribute__((sdx_kernel("cfu_hls", 0))) void cfu_hls(
    char funct3_i,
    char funct7_i,
    int src1_i ,
    int src2_i ,
    int* rslt_o ) {
#line 1 "directive"
#pragma HLSDIRECTIVE TOP name=cfu_hls
# 8 "cfu_hls.c"

#line 12 "/home/fujino/Projects/GitHub/CFU-Proving-Ground/constr/cfu_hls.cfg"
#pragma HLSDIRECTIVE INTERFACE ap_none port=rslt_o
# 8 "cfu_hls.c"


    float x; x = *((float *)&src1_i);
    float y; y = *((float *)&src2_i);
    float u = 0.0;
    float v = 0.0;
    float u2 = 0.0;
    float v2 = 0.0;
    int k;
    kernel: for (k = 1; k < 256; k++) {
