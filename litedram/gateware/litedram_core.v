...
module litedram_core (
    ...
    input  wire   [23:0] user_port_native_cmd_addr,
    output wire          user_port_native_cmd_ready,
    input  wire          user_port_native_cmd_valid,
    input  wire          user_port_native_cmd_we,
    output wire  [127:0] user_port_native_rdata_data,
    input  wire          user_port_native_rdata_ready,
    output wire          user_port_native_rdata_valid,
    input  wire  [127:0] user_port_native_wdata_data,
    output wire          user_port_native_wdata_ready,
    input  wire          user_port_native_wdata_valid,
    input  wire   [15:0] user_port_native_wdata_we,
...
reg     [1:0] main_litedramcore_bankmachine0_trascon_count = 2'd0;
(* dont_touch = "true" *)
reg           main_litedramcore_bankmachine0_trascon_ready = 1'd0;
wire          main_litedramcore_bankmachine0_trascon_valid;
reg     [1:0] main_litedramcore_bankmachine0_trccon_count = 2'd0;
(* dont_touch = "true" *)
...
reg     [1:0] main_litedramcore_bankmachine1_trascon_count = 2'd0;
(* dont_touch = "true" *)
reg           main_litedramcore_bankmachine1_trascon_ready = 1'd0;
wire          main_litedramcore_bankmachine1_trascon_valid;
reg     [1:0] main_litedramcore_bankmachine1_trccon_count = 2'd0;
(* dont_touch = "true" *)
...
reg     [1:0] main_litedramcore_bankmachine2_trascon_count = 2'd0;
(* dont_touch = "true" *)
reg           main_litedramcore_bankmachine2_trascon_ready = 1'd0;
wire          main_litedramcore_bankmachine2_trascon_valid;
reg     [1:0] main_litedramcore_bankmachine2_trccon_count = 2'd0;
(* dont_touch = "true" *)
...
reg     [1:0] main_litedramcore_bankmachine3_trascon_count = 2'd0;
(* dont_touch = "true" *)
reg           main_litedramcore_bankmachine3_trascon_ready = 1'd0;
wire          main_litedramcore_bankmachine3_trascon_valid;
reg     [1:0] main_litedramcore_bankmachine3_trccon_count = 2'd0;
(* dont_touch = "true" *)
...
reg     [1:0] main_litedramcore_bankmachine4_trascon_count = 2'd0;
(* dont_touch = "true" *)
reg           main_litedramcore_bankmachine4_trascon_ready = 1'd0;
wire          main_litedramcore_bankmachine4_trascon_valid;
reg     [1:0] main_litedramcore_bankmachine4_trccon_count = 2'd0;
(* dont_touch = "true" *)
...
reg     [1:0] main_litedramcore_bankmachine5_trascon_count = 2'd0;
(* dont_touch = "true" *)
reg           main_litedramcore_bankmachine5_trascon_ready = 1'd0;
wire          main_litedramcore_bankmachine5_trascon_valid;
reg     [1:0] main_litedramcore_bankmachine5_trccon_count = 2'd0;
(* dont_touch = "true" *)
...
reg     [1:0] main_litedramcore_bankmachine6_trascon_count = 2'd0;
(* dont_touch = "true" *)
reg           main_litedramcore_bankmachine6_trascon_ready = 1'd0;
wire          main_litedramcore_bankmachine6_trascon_valid;
reg     [1:0] main_litedramcore_bankmachine6_trccon_count = 2'd0;
(* dont_touch = "true" *)
...
reg     [1:0] main_litedramcore_bankmachine7_trascon_count = 2'd0;
(* dont_touch = "true" *)
reg           main_litedramcore_bankmachine7_trascon_ready = 1'd0;
wire          main_litedramcore_bankmachine7_trascon_valid;
reg     [1:0] main_litedramcore_bankmachine7_trccon_count = 2'd0;
(* dont_touch = "true" *)
...
wire   [25:0] main_litedramcore_zqcs_timer_count0;
reg    [25:0] main_litedramcore_zqcs_timer_count1 = 26'd49999999;
...
assign main_user_port_cmd_valid = (user_port_native_cmd_valid & main_user_enable);
assign user_port_native_cmd_ready = (main_user_port_cmd_ready & main_user_enable);
assign main_user_port_cmd_payload_we = user_port_native_cmd_we;
assign main_user_port_cmd_payload_addr = user_port_native_cmd_addr;
assign main_user_port_wdata_valid = (user_port_native_wdata_valid & main_user_enable);
assign user_port_native_wdata_ready = (main_user_port_wdata_ready & main_user_enable);
assign main_user_port_wdata_payload_we = user_port_native_wdata_we;
assign main_user_port_wdata_payload_data = user_port_native_wdata_data;
assign user_port_native_rdata_valid = (main_user_port_rdata_valid & main_user_enable);
assign main_user_port_rdata_ready = (user_port_native_rdata_ready & main_user_enable);
assign user_port_native_rdata_data = main_user_port_rdata_payload_data;
...
assign main_litedramcore_tfawcon_count = ((main_litedramcore_tfawcon_window[0] + main_litedramcore_tfawcon_window[1]) + main_litedramcore_tfawcon_window[2]);
always @(*) begin
...
always @(*) begin
    ...
    case (main_litedramcore_steerer_sel0)
        1'd0: begin
            builder_array_muxed0 <= main_litedramcore_nop_ba;
        end
        1'd1: begin
            builder_array_muxed0 <= main_litedramcore_choose_cmd_cmd_payload_ba;
        end
        2'd2: begin
            builder_array_muxed0 <= main_litedramcore_choose_req_cmd_payload_ba;
        end
        default: begin
            builder_array_muxed0 <= main_litedramcore_cmd_payload_ba;
        end
    endcase
end
always @(*) begin
...
always @(*) begin
    ...
    case (main_litedramcore_steerer_sel1)
        1'd0: begin
            builder_array_muxed7 <= main_litedramcore_nop_ba;
        end
        1'd1: begin
            builder_array_muxed7 <= main_litedramcore_choose_cmd_cmd_payload_ba;
        end
        2'd2: begin
            builder_array_muxed7 <= main_litedramcore_choose_req_cmd_payload_ba;
        end
        default: begin
            builder_array_muxed7 <= main_litedramcore_cmd_payload_ba;
        end
    endcase
end
always @(*) begin
...
always @(*) begin
    ...
    case (main_litedramcore_steerer_sel2)
        1'd0: begin
            builder_array_muxed14 <= main_litedramcore_nop_ba;
        end
        1'd1: begin
            builder_array_muxed14 <= main_litedramcore_choose_cmd_cmd_payload_ba;
        end
        2'd2: begin
            builder_array_muxed14 <= main_litedramcore_choose_req_cmd_payload_ba;
        end
        default: begin
            builder_array_muxed14 <= main_litedramcore_cmd_payload_ba;
        end
    endcase
end
always @(*) begin
...
always @(*) begin
    ...
    case (main_litedramcore_steerer_sel3)
        1'd0: begin
            builder_array_muxed21 <= main_litedramcore_nop_ba;
        end
        1'd1: begin
            builder_array_muxed21 <= main_litedramcore_choose_cmd_cmd_payload_ba;
        end
        2'd2: begin
            builder_array_muxed21 <= main_litedramcore_choose_req_cmd_payload_ba;
        end
        default: begin
...
always @(posedge sys_clk) begin
    ...
    if ((main_litedramcore_timer_wait & (~main_litedramcore_timer_done0))) begin
        ...
        main_litedramcore_timer_count1 <= 9'd390;
    end
    ...
    if ((main_litedramcore_sequencer_counter == 6'd34)) begin
        main_litedramcore_cmd_payload_a <= 1'd0;
        main_litedramcore_cmd_payload_ba <= 1'd0;
        main_litedramcore_cmd_payload_cas <= 1'd0;
        main_litedramcore_cmd_payload_ras <= 1'd0;
    ...
    if ((main_litedramcore_zqcs_timer_wait & (~main_litedramcore_zqcs_timer_done0))) begin
        ...
        main_litedramcore_zqcs_timer_count1 <= 26'd49999999;
    end
    ...
    if ((main_litedramcore_zqcs_executer_counter == 2'd2)) begin
        main_litedramcore_cmd_payload_a <= 1'd0;
        main_litedramcore_cmd_payload_ba <= 1'd0;
        main_litedramcore_cmd_payload_cas <= 1'd0;
        main_litedramcore_cmd_payload_ras <= 1'd0;
    ...
    if ((main_litedramcore_zqcs_executer_counter == 5'd18)) begin
        main_litedramcore_cmd_payload_a <= 1'd0;
        main_litedramcore_cmd_payload_ba <= 1'd0;
        main_litedramcore_cmd_payload_cas <= 1'd0;
        main_litedramcore_cmd_payload_ras <= 1'd0;
    ...
    if (main_litedramcore_bankmachine0_twtpcon_valid) begin
        main_litedramcore_bankmachine0_twtpcon_count <= 3'd4;
        if (1'd0) begin
    ...
    if (main_litedramcore_bankmachine0_trccon_valid) begin
        main_litedramcore_bankmachine0_trccon_count <= 2'd3;
        if (1'd0) begin
    ...
    if (main_litedramcore_bankmachine0_trascon_valid) begin
        main_litedramcore_bankmachine0_trascon_count <= 2'd2;
        if (1'd0) begin
    ...
    if (main_litedramcore_bankmachine1_twtpcon_valid) begin
        main_litedramcore_bankmachine1_twtpcon_count <= 3'd4;
        if (1'd0) begin
    ...
    if (main_litedramcore_bankmachine1_trccon_valid) begin
        main_litedramcore_bankmachine1_trccon_count <= 2'd3;
        if (1'd0) begin
    ...
    if (main_litedramcore_bankmachine1_trascon_valid) begin
        main_litedramcore_bankmachine1_trascon_count <= 2'd2;
        if (1'd0) begin
    ...
    if (main_litedramcore_bankmachine2_twtpcon_valid) begin
        main_litedramcore_bankmachine2_twtpcon_count <= 3'd4;
        if (1'd0) begin
    ...
    if (main_litedramcore_bankmachine2_trccon_valid) begin
        main_litedramcore_bankmachine2_trccon_count <= 2'd3;
        if (1'd0) begin
    ...
    if (main_litedramcore_bankmachine2_trascon_valid) begin
        main_litedramcore_bankmachine2_trascon_count <= 2'd2;
        if (1'd0) begin
    ...
    if (main_litedramcore_bankmachine3_twtpcon_valid) begin
        main_litedramcore_bankmachine3_twtpcon_count <= 3'd4;
        if (1'd0) begin
    ...
    if (main_litedramcore_bankmachine3_trccon_valid) begin
        main_litedramcore_bankmachine3_trccon_count <= 2'd3;
        if (1'd0) begin
    ...
    if (main_litedramcore_bankmachine3_trascon_valid) begin
        main_litedramcore_bankmachine3_trascon_count <= 2'd2;
        if (1'd0) begin
    ...
    if (main_litedramcore_bankmachine4_twtpcon_valid) begin
        main_litedramcore_bankmachine4_twtpcon_count <= 3'd4;
        if (1'd0) begin
    ...
    if (main_litedramcore_bankmachine4_trccon_valid) begin
        main_litedramcore_bankmachine4_trccon_count <= 2'd3;
        if (1'd0) begin
    ...
    if (main_litedramcore_bankmachine4_trascon_valid) begin
        main_litedramcore_bankmachine4_trascon_count <= 2'd2;
        if (1'd0) begin
    ...
    if (main_litedramcore_bankmachine5_twtpcon_valid) begin
        main_litedramcore_bankmachine5_twtpcon_count <= 3'd4;
        if (1'd0) begin
    ...
    if (main_litedramcore_bankmachine5_trccon_valid) begin
        main_litedramcore_bankmachine5_trccon_count <= 2'd3;
        if (1'd0) begin
    ...
    if (main_litedramcore_bankmachine5_trascon_valid) begin
        main_litedramcore_bankmachine5_trascon_count <= 2'd2;
        if (1'd0) begin
    ...
    if (main_litedramcore_bankmachine6_twtpcon_valid) begin
        main_litedramcore_bankmachine6_twtpcon_count <= 3'd4;
        if (1'd0) begin
    ...
    if (main_litedramcore_bankmachine6_trccon_valid) begin
        main_litedramcore_bankmachine6_trccon_count <= 2'd3;
        if (1'd0) begin
    ...
    if (main_litedramcore_bankmachine6_trascon_valid) begin
        main_litedramcore_bankmachine6_trascon_count <= 2'd2;
        if (1'd0) begin
    ...
    if (main_litedramcore_bankmachine7_twtpcon_valid) begin
        main_litedramcore_bankmachine7_twtpcon_count <= 3'd4;
        if (1'd0) begin
    ...
    if (main_litedramcore_bankmachine7_trccon_valid) begin
        main_litedramcore_bankmachine7_trccon_count <= 2'd3;
        if (1'd0) begin
    ...
    if (main_litedramcore_bankmachine7_trascon_valid) begin
        main_litedramcore_bankmachine7_trascon_count <= 2'd2;
        if (1'd0) begin
    ...
    if (sys_rst) begin
        ...
        main_litedramcore_bankmachine0_trccon_ready <= 1'd0;
        main_litedramcore_bankmachine0_trccon_count <= 2'd0;
        main_litedramcore_bankmachine0_trascon_ready <= 1'd0;
        main_litedramcore_bankmachine0_trascon_count <= 2'd0;
        ...
        main_litedramcore_bankmachine1_trccon_ready <= 1'd0;
        main_litedramcore_bankmachine1_trccon_count <= 2'd0;
        main_litedramcore_bankmachine1_trascon_ready <= 1'd0;
        main_litedramcore_bankmachine1_trascon_count <= 2'd0;
        ...
        main_litedramcore_bankmachine2_trccon_ready <= 1'd0;
        main_litedramcore_bankmachine2_trccon_count <= 2'd0;
        main_litedramcore_bankmachine2_trascon_ready <= 1'd0;
        main_litedramcore_bankmachine2_trascon_count <= 2'd0;
        ...
        main_litedramcore_bankmachine3_trccon_ready <= 1'd0;
        main_litedramcore_bankmachine3_trccon_count <= 2'd0;
        main_litedramcore_bankmachine3_trascon_ready <= 1'd0;
        main_litedramcore_bankmachine3_trascon_count <= 2'd0;
        ...
        main_litedramcore_bankmachine4_trccon_ready <= 1'd0;
        main_litedramcore_bankmachine4_trccon_count <= 2'd0;
        main_litedramcore_bankmachine4_trascon_ready <= 1'd0;
        main_litedramcore_bankmachine4_trascon_count <= 2'd0;
        ...
        main_litedramcore_bankmachine5_trccon_ready <= 1'd0;
        main_litedramcore_bankmachine5_trccon_count <= 2'd0;
        main_litedramcore_bankmachine5_trascon_ready <= 1'd0;
        main_litedramcore_bankmachine5_trascon_count <= 2'd0;
        ...
        main_litedramcore_bankmachine6_trccon_ready <= 1'd0;
        main_litedramcore_bankmachine6_trccon_count <= 2'd0;
        main_litedramcore_bankmachine6_trascon_ready <= 1'd0;
        main_litedramcore_bankmachine6_trascon_count <= 2'd0;
        ...
        main_litedramcore_bankmachine7_trccon_ready <= 1'd0;
        main_litedramcore_bankmachine7_trccon_count <= 2'd0;
        main_litedramcore_bankmachine7_trascon_ready <= 1'd0;
        main_litedramcore_bankmachine7_trascon_count <= 2'd0;
        main_litedramcore_choose_cmd_grant <= 3'd0;
        main_litedramcore_choose_req_grant <= 3'd0;
        main_litedramcore_trrdcon_ready <= 1'd0;
        main_litedramcore_trrdcon_count <= 1'd0;
        main_litedramcore_tfawcon_ready <= 1'd1;
        main_litedramcore_tfawcon_window <= 3'd0;
        main_litedramcore_tccdcon_ready <= 1'd0;
        main_litedramcore_tccdcon_count <= 1'd0;
        main_litedramcore_twtrcon_ready <= 1'd0;
...
// -----------------------------------------------------------------------------
//  Auto-Generated by LiteX on 2025-09-30 09:13:31.
//------------------------------------------------------------------------------
